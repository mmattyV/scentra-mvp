...
const fragrancesArray: Fragrance[] = Array.isArray(FRAGRANCES)
  ? FRAGRANCES
  : [];
...
export default function ProductDetailsPage() {
  ...
  // Modals
  const [isGuaranteePolicyOpen, setGuaranteePolicyOpen] = useState(false);
  const [isVerificationOpen, setVerificationOpen] = useState(false);

  // Get fragrance details from the static data
  const fragranceDetails = fragrancesArray.find(
    (f) => f.productId === fragranceId
  );
      ...
      await Promise.all(
        listings.map(async (listing) => {
          ...
          try {
            ...
            console.error(
              `Error fetching image for listing ${listing.id}:`,
              error
            );
        ...
        <div className="min-h-screen bg-white flex items-center justify-center">
          <div className="text-center max-w-md px-4">
            ...
            <p className="text-gray-600 mb-4">
              We couldn't find the fragrance you're looking for.
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-white">
            ...
            <div>
              ...
              <div className="space-y-6">
                            ...
                            <div>
                              ...
                              <div className="text-sm text-gray-600 mt-1">
                                ...
                                {listing.condition === "used" &&
                                  listing.percentRemaining !== undefined &&
                                  listing.percentRemaining <= 100 && (
                ...
                <div className="pt-6 border-t space-y-4 mt-auto">
                  <div>
                    <button
                      onClick={() => setGuaranteePolicyOpen(true)}
      ...
      <div className="container mx-auto px-4 py-6 mt-4 border-t border-gray-200">
        <p className="text-xs text-gray-500 text-center">
          Scentra is not endorsed, affiliated with, or authorized by {fragranceDetails.brand}. {fragranceDetails.brand}'s trademarks, bottle designs, and logos are property of this brand.
        </p>
      </div>

      {/* Return Policy Modal */}
      {isGuaranteePolicyOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg p-8 max-w-md w-full shadow-xl">
            ...
            <p className="text-gray-700 leading-relaxed">
              At Scentra, all sales are final once the authentication and
              verification process is complete. If you receive a product that
              doesn't match the verified condition, please contact our customer
              service team within 48 hours of delivery.
            </p>
            <button
              onClick={() => setGuaranteePolicyOpen(false)}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg p-8 max-w-md w-full shadow-xl">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              This item is <strong>verified by Scentra</strong>.
            </p>
            <p className="text-gray-700 leading-relaxed mb-4">
              Fragrances sold on Scentra are shipped from sellers to our
              Verification Center, where our expert team uses a rigorous,
              multi-step process to confirm authenticity and condition.
            </p>
            <ol className="list-decimal pl-5 space-y-2 text-gray-700 mb-4">
              <li>The product is 100% authentic</li>
              <li>The condition matches the listed description</li>
              <li>The remaining volume is as advertised</li>
            </ol>
            <p className="text-gray-700 leading-relaxed">
              Only after passing all checks is the fragrance shipped to you.
            </p>
            <p className="text-gray-700 leading-relaxed font-semibold mt-4">
              And if something isn’t right, our team will make it
              right—guaranteed.
            </p>
            <button
